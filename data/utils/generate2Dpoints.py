...
def main():
	...
	pathToDataset = os.path.join(dataset_path, "annotated_frames")
	...
	for i in range(1,22):
		...
		print(f"Loading calibration for {dataset_path}/calibrations/data_"+str(i))
		c_0_0 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_1/rvec.pkl","rb"), encoding="latin-1")
		c_0_1 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_1/tvec.pkl","rb"), encoding="latin-1")
		c_1_0 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_2/rvec.pkl","rb"), encoding="latin-1")
		c_1_1 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_2/tvec.pkl","rb"), encoding="latin-1")
		c_2_0 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_3/rvec.pkl","rb"), encoding="latin-1")
		c_2_1 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_3/tvec.pkl","rb"), encoding="latin-1")
		c_3_0 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_4/rvec.pkl","rb"), encoding="latin-1")
		c_3_1 = pickle.load(open(f"{dataset_path}/calibrations/data_"+str(i)+"/webcam_4/tvec.pkl","rb"), encoding="latin-1")
		...
		for j in range(len(colorFrames)):
			...
			jointPath = os.path.join(path, toks2[0]+"_joints.txt")
			...
			pathToSave = os.path.join(f"{dataset_path}\\projections_2d", "data_"+str(i),  toks2[0]+"_jointsCam_"+toks2[2].split(".")[0]+".txt")
